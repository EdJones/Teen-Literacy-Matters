    ...
    <Page class="page">
      <ActionBar class="action-bar">
        ...
        <GridLayout class="">
          ...
          <Label class="text-2xl text-center" text="The Problem"  />
            <Label class="text-base leading-none p-4 pb-0" text="Let's explore the problem further." textWrap="true" />
           
           
             
 <Button text="Reading Vs Prison" @tap="showModal(next)" class="button-active help-button page-link" width="50%" />
 <Button text="How ‘Reading Instruction’ Fails Black And Brown Children" @tap="showModal(next)" class="button-active help-button page-link" width="50%" />
          </StackLayout>
        </GridLayout>
    </Page>
</template>
